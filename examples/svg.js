...
async function setup() {
    ...
    setupComplete();
    console.log('setup complete done');
    ...
    const font = await window.electronApi.readFile('/Users/jmcgill/Downloads/EMSBrush.svg');
    const f$ = $(font);
    f$.find("glyph").each((e) => {
       console.log(e);
    });
...
// \t viewBox="0 0 841.89001 1190.55005" style="enable-background:new 0 0 841.89001 1190.55005;" xml:space="preserve">
// <style type="text/css">
// \t.st0{fill:none;stroke:#231F20;stroke-miterlimit:10;}
// </style>
// <rect x="-134.34225" y="432" transform="matrix(6.123234e-17 -1 1 6.123234e-17 -134.34225 1017.65778)" class="st0" width="1152" height="288"/>
// </svg>`;
